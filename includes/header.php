<?php
        ...
        define("APPURL", "Https://localhost/mebookstore"); 
  ...
  <body>
    ...
    <div class="container" style="margin-top: none">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link active  text-white" aria-current="page" href="<?php echo APPURL; ?>/bookstore/categories/index.php">Categories</a>
            </li>
