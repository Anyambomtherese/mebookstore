                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <form method ="post" id="form-data">
                                     <div class="">
                            <input type="email"  name="pro_id" value="<?php echo $product->id; ?>"  class="form-control">
                            </div>
                            <div class="">
                                <input type="email"  name="pro_name" value="<?php echo $product->name; ?>"  class="form-control">
                            </div> 
                            <div class="">
                                <input type="email"  name="pro_image" value="<?php echo $product->image; ?>"  class="form-control">
                            </div> 
                            <div class="">
                                <input type="email"  name="pro_price" value="<?php echo $product->price; ?>"  class="form-control">
                            </div>
                            <div class="">
                                <input type="email"  name="pro_amount" value="1"  class="form-control">
                            </div>  
                                <div class="">
                                <input type="email"  name="pro_file" value="<?php echo $product->file; ?>"  class="form-control">
                            </div>
                                <input type="email"  name="user_id" value="<?php echo $_SESSION['user_id']; ?>"  class="form-control">
                            </div>
